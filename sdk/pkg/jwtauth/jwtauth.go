...
type GinJWTMiddleware struct {
	...
	// Callback function that should perform the authentication of the db_user based on login info.
	// Must return db_user data as db_user identifier, it will be stored in Claim Array. Required.
	// Check error (e) to determine the appropriate error message.
	Authenticator func(c *gin.Context) (interface{}, error)

	// Callback function that should perform the authorization of the authenticated db_user. Called
